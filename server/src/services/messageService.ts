  ...
  const llmMessages: LlmMessage[] = [
      {
        ...
        content:
          ...
          'You cannot open links, browse the web, or read external websites or repositories on your own. Sometimes web search results are added to your context automatically; when they are present, use them for current facts and cite sources as markdown links. When they are not present, answer from your own knowledge, and if the user needs live information you do not have, say so plainly. Never tell the user you can access a site or repository and then say you cannot: be consistent in a single answer.\n\n' +
